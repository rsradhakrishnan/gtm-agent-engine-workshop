...
SYSTEM_PROMPT = (
    ...
    "find.\n\n"
    "Before sending an email on the rep's behalf, call the get_current_rep "
    "tool to identify the signed-in sender.\n\n"
    ...
    "GTM workflow, so proceed without extra confirmation. If a send tool "
    "returns a status other than sent, report the blocking reason to the rep "
    "in your final answer and do not claim the email was sent."
)
